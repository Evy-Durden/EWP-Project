...
This chapter is a brief overview of through tools and technologies used in the project.
...
The goal is to create a more advanced command line interface to facilitate all the required options and ensure a great user experience. The choice for the appropriate framework fell on \textit{Typer}. It offers advanced features such as pervasive autocompletion and it is highly extensible which supports scalability\footnote{MengLi. Typer: Powerful Python CLI Framework with Type Hints. [online] homepage: medium.com URL: https://medium.com/top-python-libraries/typer-powerful-python-cli-framework-with-type-hints-6b16654daac7 [Accessed 05.01.2026]}. Moreover it is based on type hints \footnote{Typer. [online] homepage: typer.tiangolo.com URL: https://typer.tiangolo.com/ [Accessed 05.01.2026]} which are used to automatically parse arguments and options, validate input and generate help messages.\footnote{Didin J. Build Powerful Command-Line Tools in Python Using Typer [online] homepage: djamware.com URL: https://www.djamware.com/post/692d8641e6e2a42c2b84c3c1/build-powerful-commandline-tools-in-python-using-typer?utm\_source=chatgpt.com [Accessed 05.01.2026]}.
